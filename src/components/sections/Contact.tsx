            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="group flex items-center gap-3 p-4 border border-border rounded-lg hover:border-primary transition-all duration-300 hover:bg-primary/5"
                >
                  <span className="text-muted-foreground group-hover:text-primary transition-colors">
                    {getSocialIcon(link.platform)}
                  </span>
                  <span className="text-mono text-sm text-muted-foreground group-hover:text-primary transition-colors tracking-wide">
        ...
        <ScrollReveal delay={400}>
          <div className="mt-32 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <p className="text-mono text-sm text-muted-foreground">
              © {new Date().getFullYear()} {name} <span className="text-primary">◆</span> All rights reserved
            </p>
          </div>
        </ScrollReveal>
      </div>
